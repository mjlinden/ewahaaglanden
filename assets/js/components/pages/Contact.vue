<template>
    <div id="contact">
        <form class="vue-form" action="https://formspree.io/xoqkqgry" method="POST">
            <div class="error-message">
                <p v-show="!email.valid">Vul een geldig email adres in.</p>
            </div>
            <fieldset>
                <legend>Ewa Haaglanden Contact Formulier</legend>
                <div>
                    <label class="label" for="name">Naam</label>
                    <input type="text" name="Naam" id="name" required="" v-model="name" placeholder="Typ hier uw naam">
                </div>
                <div>
                    ...
                    <input type="email" name="Email" id="email" required=""
                           ...
                           v-model="email.value"
                           placeholder="Typ hier uw email adres">
                </div>
<!--                <div>-->
<!--                    <h4>Team Member</h4>-->
<!--                    <p class="select">-->
...
<!--                </div>-->
                <div>
                    <label class="label" for="textarea">Uw bericht</label>
                    <textarea class="message" name="Bericht" id="textarea" required=""
